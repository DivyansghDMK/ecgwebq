...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 bg-slate-950/75 backdrop-blur-xl">
      <div className="mx-auto flex min-h-[5rem] w-full max-w-[100rem] items-center gap-5 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <button
          type="button"
          className="ml-auto inline-flex items-center justify-center rounded-full border border-white/15 p-2 text-white/80 lg:hidden"
